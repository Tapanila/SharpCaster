...
namespace SharpCaster.Test
{
    public class DeviceLocatorTests
    {
        ...
        public DeviceLocatorTests()
        {
            ...
            _deviceLocator = new DeviceLocator { SocketService = _dummySocketService };
        ...
        {
            _cancellationTokenSource.CancelAfter(TimeSpan.FromMilliseconds(500));
            var devices = await _deviceLocator.LocateDevicesAsync(_cancellationTokenSource.Token);
